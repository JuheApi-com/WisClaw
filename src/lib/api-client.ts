...
const GATEWAY_WS_DIAG_FLAG = 'wisclaw:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('wisclaw:api-log') === '1';
  } catch {
